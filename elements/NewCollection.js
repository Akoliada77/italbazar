...
export default class NewCollection {
    ...
    async checkDetailsButton() {
        ...
        const cost2 = await getText(page, '#root > div:nth-child(3) > div > div.desktop_product_page_container__2HFDF > div.desktop_product_page_productInfo__2UahX > div.main_info_block_priceBlock__2XeTd > div.main_info_block_currentPrice__31hdv > span')
